...
window.handbook = {
  ...
  "glossary": [
    {
      "term": "心智模型",
      "definition": "一个人看世界的镜片，能用来推断他对没讨论过的新问题的立场。",
      "example": "纳瓦尔的「杠杆」——在财富、成长、职业选择三个域复现，且能推断他对没谈过的新问题（如远程办公）会怎么看。",
    ...
    {
      "term": "决策启发式",
      "definition": "此人做判断的快速规则，能写成「如果 X 则 Y」并有案例支撑。",
      "example": "乔布斯：「如果要做市场调研，就已经输了」——具体场景的判断规则，带案例，但没有跨域复现到心智模型那一级。",
    ...
    {
      "term": "表达 DNA",
      "definition": "此人说话的可量化指纹：句式偏好、高频词、节奏、幽默方式、确定性表达。",
      "example": "对 20 个真实段落做统计：类比密度（每段几个类比）、转折频率（\"但是\"出现率）、确定性用语（\"绝对/也许\"之比）——量化出来的指纹，不是印象。",
    ...
    },
    {
      ...
      "example": "「杠杆」过三重：财富/职业/学习三域都出现 ✓、能推断对新问题的立场 ✓、并非人人把它当第一原则 ✓ → 升级为模型；「专注很重要」只过跨域一重 → 降级为启发式都勉强。",
    ...
    },
    {
      ...
      "example": "「05 决策维度只找到 2 条可用来源，本节判断置信度低」——具体到维度和条数，而不是一句「仅供参考」。",
    ...
    },
    {
      ...
      "example": "问芒格 Vision Pro 值不值得做 → 协议判定\"要事实\" → 先查激励结构与单位经济（维度来自他的模型），查完才答；不是通用的「搜索相关信息」。",
