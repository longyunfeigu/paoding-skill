...
## 带走候选清单（steal scan 回填，2026-06-12）

| 候选 | 镜头 | 档位 | 用在哪 | 位置 |
| --- | --- | --- | --- | --- |
| 追问与推荐双限流（2 轮 / 3 候选 / 必附局限） | 话术+知识 | 直接抄走 | 任何需求诊断、方案推荐 | stage-01 机制段 |
| 开工先钉死文件名 | 痛点 | 思路带走 | 任何多 agent 并行产出 | stage-02 机制段 |
| 只认落盘不认汇报 | 痛点 | 思路带走 | 任何会口头交差的子任务 | stage-03 机制段 |
| 研究一个人的六个面向 | 知识 | 直接抄走 | 任何人物 / 品牌 / 竞品研究 | stage-03 场景段 |
| 三重验证收录门槛 | 验法 | 直接抄走 | 任何「从素材提炼原则」的工作 | stage-04 机制段 |
| 把品味拆成可数的代理指标 | 验法 | 思路带走 | 任何「好不好」说不清的验收 | stage-06 机制段 |
